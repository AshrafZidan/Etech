...
import { IonicPage, NavController, Platform, NavParams, LoadingController, ToastController, ViewController } from 'ionic-angular';
...
export class Forgetpassword {
  ...
  requestForgetPassword() {
    ...
    loading.present();
    this.authServices.forgetPassword(this.userEmail).subscribe(
      data => {
      ...
      error => {
        this.presentToast(error.json().Message)
